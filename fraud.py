...
Original file is located at
    https://colab.research.google.com/drive/1aubzqkfmnWCllDWXo0GRViTsmKhXZObS
"""
...
dataset = pd.read_csv("/content/drive/MyDrive/Claims.csv")
...
model = Pipeline([
        ('balancing', SMOTE(random_state = 101)), ## Running SMOTE to balance the training set to ensure balanced learning, Also IMblearn's SMOTE function will only balance the training set and not the test set to replicate the real-world scenario
        ('classification', RandomForestClassifier(criterion='entropy', max_features='auto', random_state=1) )
    ])
grid_param = {'classification__n_estimators': [250,300,350,400,450]} ## specifying a grid of hyper-parameters
